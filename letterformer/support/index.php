...
<html lang="de">
  <head>
    ...
    <style>
      ...
      .support-status.error {
        border: 1px solid rgba(140, 30, 30, 0.35);
      }
      .support-note {
  ...
  <body>
    <main class="support-shell">
      <a class="support-back" href="../">← Zurück zu LetterFormer</a>
      ...
      <section class="support-card" aria-labelledby="support-title">
        ...
        <?php if ($sent): ?>
          <div class="support-status" role="status">
            <strong>Danke!</strong><br />
            Deine Nachricht wurde gesendet. Ich melde mich so bald wie möglich bei dir.
          </div>
        <?php else: ?>
          <p>
            Du hast eine Frage, einen Fehler gefunden oder möchtest Feedback zu LetterFormer senden?
            Schreib mir hier direkt über das Formular.
          </p>
          ...
          <p class="support-note">
            Deine Angaben werden nur verwendet, um deine Supportanfrage zu beantworten. Bitte sende keine sensiblen Briefinhalte über dieses Formular.
          </p>
        <?php endif; ?>
      </section>
    </main>
